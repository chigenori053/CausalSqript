...
from causalscript.core.interfaces import BaseModule
from causalscript.core.context_manager import ContextManager
from causalscript.core.parser import Parser
from causalscript.core.errors import EvaluationError, SyntaxError as DSLSyntaxError
...
class CoreOrchestrator:
    """
    The Command Tower of the CausalScript Core.
    ...
    def execute_script(self, script_text: str) -> Dict[str, Any]:
        """
        Parse and execute a full CausalScript DSL script.
