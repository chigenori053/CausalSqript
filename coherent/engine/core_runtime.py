...
from coherent.engine.errors import CoherentError, InvalidExprError, MissingProblemError
...
class CoreRuntime(Engine):
    ...
    def __init__(
        ...
        if decision_config and hasattr(self.validation_engine, 'fuzzy_judge') and self.validation_engine.fuzzy_judge:
             ...
             from coherent.engine.decision_theory import DecisionEngine
