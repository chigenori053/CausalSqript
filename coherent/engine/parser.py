...
from .input_parser import CoherentInputParser
...
class Parser:
    ...
    def _normalize_expr(self, value: str) -> str:
        return CoherentInputParser.normalize(value)
    ...
    def _normalize_statement(self, statement: str) -> str:
        ...
        if "=" in stripped:
            ...
            normalized = CoherentInputParser.normalize(expr.strip())
            return f"{name.strip()} = {normalized}"
        return CoherentInputParser.normalize(stripped)
